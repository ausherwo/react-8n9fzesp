...
 
            ...
            <div
              ...
              style={{border:`1px dashed ${rawInput?C.amber:C.border}`,borderRadius:10,padding:rawInput?0:"26px",marginBottom:11,transition:"border-color 0.2s"}}>
              ...
              {rawInput ? (
                ...
                <div style={{textAlign:"center"}} onClick={()=>ref.current?.click()}>
